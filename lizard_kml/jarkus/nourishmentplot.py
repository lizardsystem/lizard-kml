...
def combinedplot(dfs):
    ...
    props = dict(linewidth=2, alpha=0.7, markeredgewidth=0, markersize=8,
                 linestyle='-', marker='.')
    ...
    ax2.plot(date2num(dfdf['time']), dfdf['dune_foot_rsp'],
             label='duinvoet positie', **props)
    ax2.plot(date2num(shorelinedf['time']), shorelinedf['dune_foot'],
             label='historische duinvoet positie', **props)
    ax2.plot(date2num(shorelinedf['time']), shorelinedf['mean_high_water'],
             label='historische hoogwater positie', **props)
    ax2.plot(date2num(shorelinedf['time']), shorelinedf['mean_high_water'],
             label='historische laagwater positie', **props)
    ...
    '''
    ax3.plot(date2num(dfdf['time']), dfdf['dune_foot_rsp'],
             label='duinvoet positie', **props)
